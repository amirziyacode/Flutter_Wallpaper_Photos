...
class _StaggeredGridViewExampleState extends State<StaggeredGridViewExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Image.network('https://www.drupal.org/files/project-images/pexels_logo_0.png',width: 60,height: 60,),
                    const SizedBox(
                      height: 10,
                    ),
                    const Text("Pexels", style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),),
      ...
      bottomNavigationBar: custombottomnavigation(pageindex: 4,),
    );
  }
}